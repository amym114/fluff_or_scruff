defmodule FluffOrScruffWeb.CoreComponents do
  @moduledoc """
  ...
  """
  attr :type, :string, required: true, values: ["submit", "monkey"]
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FluffOrScruffWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FluffOrScruffWeb.Gettext, "errors", msg, opts)
    end
  end
